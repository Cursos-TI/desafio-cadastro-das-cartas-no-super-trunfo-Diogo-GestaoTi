   ...
   //Menu de Interativo:
    ...
    case 5:
        if (densidade1 < densidade2) {
            printf("Cidade 1 tem menor densidade demográfica.\n");
        } else if (densidade2 < densidade1){
            printf("Cidade 2 tem menor densidade demográfica.\n");
        }else{
            printf("As cidades tem a mesma densidade demográfica.\n");
        }
        break;
    case 6:
    ...
    case 7:
        if (super_poder1 > super_poder2) {
            ...
            printf("As cartas são empatadas!\n");
        }
        break;    
     default:
